                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <input
                      ...
                      name="image"
                      style="display:none;">
                    <small id="image_error" class="form-text text-danger text-center small_error"
                           style="margin-bottom: 25px;"> </small>
                  </div>
                </div>
                <hr>
              </div>
                  ...
                  <div class="form-group row">
                    <div class="col-md-3">
                      <input type="text" id="choice1" class="form-control" name="{{$lang}}[right_answer]"
                             placeholder="@lang('locale.right_answer')"
                             value="{{$record->translate($lang)->right_answer}}">
                      <small id="{{$lang.'_right_answer_error'}}"
                    ...
                    <div class="col-md-3">
                      ...
                      <small id="{{$lang.'_wrongans_1_error'}}"
                             class="form-text text-danger center small_error"> </small>
                    </div>
                    <div class="col-md-3">
                      ...
                      <small id="{{$lang.'_wrongans_2_error'}}"
                             class="form-text text-danger center small_error"> </small>
                    </div>
                    <div class="col-md-3">
                      ...
                      <small id="{{$lang.'_wrongans_3_error'}}"
                             class="form-text text-danger center small_error"> </small>
                    </div>
                  </div>
                </div>
