...
@section('title', 'Edit Licensecode Page')
          ...
          <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <div class="media mb-2">
              ...
              <div class="media-body mt-50">
                <h4 class="media-heading">{{ $licensecode->name }} </h4>
                <div class="col-12 d-flex mt-1 px-0">
                  <a href="#" onclick="event.preventDefault(); document.getElementById('form').submit();"
                     class="btn btn-primary d-none d-sm-block mr-75">Change</a>
            ...
            <form novalidate id="form" action="{{ url('app-licensecode-UpdateOrCreate')  }}" method="POST" >
              {{ method_field('PUT') }}
              {{ csrf_field() }}
              <div class="row">
                <input type="hidden"  name="id" value="{{ $licensecode->id  ?  $licensecode->id  :  '' }}" >
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <div class="controls">
                      <label>Username</label>
                      <input type="text" class="form-control" placeholder="Username"  name="Username" value="adoptionism744" required
                  ...
                  <div class="form-group">
                    <div class="controls">
                      <label>Name</label>
                      <input type="text" class="form-control" placeholder="Name" name="name" value="  {{ $licensecode->name }}" required
                  ...
                  <div class="form-group">
                    <div class="controls">
                      <label>E-mail</label>
                      <input type="email" class="form-control" placeholder="Email"  name="email"  value="{{ $licensecode->email }}"
